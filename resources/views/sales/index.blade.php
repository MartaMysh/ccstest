...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container-fluid">
        <a class="navbar-brand h1" href={{ route('sales.index') }}>Game sales</a>
        <div class="justify-end ">
            <div class="col ">
                <span class="btn btn-sm btn-success showForm">Add new sale</span>
            ...
            <div class="col-10 col-md-8 col-lg-6">
                ...
                <form action="{{ route('sales.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="board_game_id">Game name</label>
                        <select class="form-control" id="board_game_id" name="board_game_id" required>
            ...
            <div class="col-sm">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">
                            <a class="navbar-brand h5" href="{{ route('boardGames.show', $sale->board_game_id) }}">
                                {{ $games[$sale->board_game_id] }}</a>
                        </h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">{{ $sale->price }} zł</p>
                        <p class="card-text">{{ $sale->market }}
                        <p class="card-text">{{ $sale->customer }}
                        <p class="card-text">{{ $sale->created_at }}
                    </div>
